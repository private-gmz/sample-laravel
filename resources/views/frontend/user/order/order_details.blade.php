...
<div class="body-content">
  <div class="container">
    <div class="row">
            ...
            <table class="table">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="col-md-2">
                    <label for=""> {{ $item->attributes }}</label>
                  </td>
      ...
      <form action="{{ route('return.cancel',$order->id) }}" method="post">
        @csrf
      ...
      @else
      <span class="badge badge-pill badge-warning" style="background: red">You Have send cancel request for this
        product</span>
      @endif
